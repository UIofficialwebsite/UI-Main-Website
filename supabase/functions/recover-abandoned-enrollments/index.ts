...
<body style="margin:0;padding:0;background:#f1f5f9;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border:1px solid #e2e8f0;border-radius:10px;">
        <tr><td style="padding:32px 32px 0 32px;">
          <p style="margin:0 0 24px;font-family:${font};font-size:12px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#1a56db;">Unknown IITians</p>
        ...
        <tr><td style="padding:20px 32px 0 32px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;">
            <tr><td style="padding:16px 20px;">
              ...
              <p style="margin:0;font-family:${font};font-size:18px;font-weight:700;letter-spacing:2px;color:#1a56db;">${COUPON}</p>
            </td></tr>
          </table>
        </td></tr>

        <tr><td style="padding:24px 32px 32px 32px;">
          <a href="${url}" style="display:inline-block;background:#1a56db;color:#ffffff;font-family:${font};font-size:14px;font-weight:600;text-decoration:none;padding:12px 28px;border-radius:8px;">Complete enrolment</a>
        </td></tr>
