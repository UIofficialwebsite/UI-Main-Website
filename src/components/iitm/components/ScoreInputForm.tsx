    ...
    <div className="mb-12 w-full animate-in fade-in slide-in-from-bottom-4 duration-500 font-['Inter']">
      ...
      <div className="mb-6 p-4 bg-[#f8f9fa] border border-gray-200 rounded-sm">
        <p className="text-[13px] text-gray-600 font-['Inter'] leading-relaxed">
          <strong className="text-gray-800">Important Note:</strong> If you were absent for an exam or quiz, leave the field completely blank. If you attended but scored zero, enter <strong>0</strong>. Leaving mandatory components blank will result in an automatic 'U' grade.
        </p>
      </div>
