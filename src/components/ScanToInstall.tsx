 ...
 *
 * A small arrow tab sits at the top-left corner of the QR block. When collapsed
 * the tab shows a phone icon beside the arrow; clicking reveals / hides the QR
 * with a horizontal "curtain" slide. Points at the install deep-link so a
 * desktop visitor can scan it and get the install prompt on their phone. Hidden
 * on mobile (where the on-page InstallAppPrompt handles installation instead).
 */
